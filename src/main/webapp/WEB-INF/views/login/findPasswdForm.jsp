...
function findPasswd(){
	...
	gfn_ajax_call_data(data, "/findPasswd", "findPasswdSuccess");
	
}

function gfn_ajax_callBack(data, type){
	if(data.resultCode == SUCCESS_CODE ){
		if(type == "findPasswdSuccess"){
			alert("findPasswdSuccess");
		}
	}else{
		alert("존재하지 않는 회원입니다.");
	}
                    ...
                    <div class="form-input-content">
                        <div class="card login-form mb-0">
                            <div class="card-body pt-5">
                                <a class="text-center"> <h4>비밀번호 찾기</h4></a>
                                ...
                                <form class="mt-5 mb-5 login-input" id="login">
                                    ...
                                    <div class="form-group">
                                    <button class="btn login-form__btn submit w-100" onclick="javascript:findPasswd()">비밀번호 찾기</button>
                                    </div>
                                </form>
                            </div>
                        </div>
